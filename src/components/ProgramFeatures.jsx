const ProgramFeatures = () => {
  return (
    <section className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-gradient-to-br from-amber-900 to-orange-800 p-8 rounded-xl shadow-2xl hover:shadow-orange-900/20 transition-all hover:scale-105 border border-amber-800/30">
            <div className="w-12 h-12 bg-amber-700/50 rounded-full flex items-center justify-center mb-6">
